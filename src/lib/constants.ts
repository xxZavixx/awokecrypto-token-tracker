 ...
 */
export const APP_DESCRIPTION: string = '“A simple Farcaster mini app for tracking live crypto token prices from AwokeCrypto.xyz.”';
 ...
 */
export const APP_TAGS: string[] = ['crypto', 'tokens', 'tracker', 'prices', 'portfolio', 'awokecrypto'];
